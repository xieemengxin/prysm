...
// Hash: 2287c4c2497ee4247f81c9ec5522b90e98c5a63391509f5601d795c98f84a0b9
package eth
...
func (b *BeaconStateElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (40) 'PendingTermWithdrawals'
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o11, o12, o15, o16, o21, o24, o27, o34, o35, o36, o37, o38, o40 uint64
	...
	// Offset (38) 'PendingTermDeposits'
	if o38 = ssz.ReadOffset(buf[2736717:2736721]); o38 > size || o37 > o38 {
		return ssz.ErrOffset
	}

	// Field (39) 'NextTermDepositId'
	b.NextTermDepositId = ssz.UnmarshallUint64(buf[2736721:2736729])

	// Offset (40) 'PendingTermWithdrawals'
	if o40 = ssz.ReadOffset(buf[2736729:2736733]); o40 > size || o38 > o40 {
		return ssz.ErrOffset
	}

	// Field (41) 'TermDepositPenaltyPool'
	b.TermDepositPenaltyPool = ssz.UnmarshallUint64(buf[2736733:2736741])

	// Field (42) 'TermDepositPenaltyPoolLastDistributionEpoch'
	b.TermDepositPenaltyPoolLastDistributionEpoch = github_com_OffchainLabs_prysm_v6_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2736741:2736749]))
...
// MarshalSSZ ssz marshals the TermDeposit object
func (t *TermDeposit) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(t)
}

// MarshalSSZTo ssz marshals the TermDeposit object to a target array
func (t *TermDeposit) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf

	// Field (0) 'DepositId'
	dst = ssz.MarshalUint64(dst, t.DepositId)

	// Field (1) 'ValidatorIndex'
	dst = ssz.MarshalUint64(dst, uint64(t.ValidatorIndex))

	// Field (2) 'Amount'
	dst = ssz.MarshalUint64(dst, t.Amount)

	// Field (3) 'StartEpoch'
	dst = ssz.MarshalUint64(dst, uint64(t.StartEpoch))

	// Field (4) 'TermDuration'
	dst = ssz.MarshalUint64(dst, t.TermDuration)

	// Field (5) 'MaturityEpoch'
	dst = ssz.MarshalUint64(dst, uint64(t.MaturityEpoch))

	// Field (6) 'GracePeriod'
	dst = ssz.MarshalUint64(dst, t.GracePeriod)

	// Field (7) 'Status'
	dst = ssz.MarshalUint64(dst, t.Status)

	// Field (8) 'RenewalCount'
	dst = ssz.MarshalUint32(dst, t.RenewalCount)

	return
}

// UnmarshalSSZ ssz unmarshals the TermDeposit object
func (t *TermDeposit) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 68 {
		return ssz.ErrSize
	...
	// Field (0) 'DepositId'
	t.DepositId = ssz.UnmarshallUint64(buf[0:8])

	// Field (1) 'ValidatorIndex'
	t.ValidatorIndex = github_com_OffchainLabs_prysm_v6_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[8:16]))

	// Field (2) 'Amount'
	t.Amount = ssz.UnmarshallUint64(buf[16:24])

	// Field (3) 'StartEpoch'
	t.StartEpoch = github_com_OffchainLabs_prysm_v6_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[24:32]))

	// Field (4) 'TermDuration'
	t.TermDuration = ssz.UnmarshallUint64(buf[32:40])

	// Field (5) 'MaturityEpoch'
	t.MaturityEpoch = github_com_OffchainLabs_prysm_v6_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[40:48]))

	// Field (6) 'GracePeriod'
	t.GracePeriod = ssz.UnmarshallUint64(buf[48:56])

	// Field (7) 'Status'
	t.Status = ssz.UnmarshallUint64(buf[56:64])

	// Field (8) 'RenewalCount'
	t.RenewalCount = ssz.UnmarshallUint32(buf[64:68])

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the TermDeposit object
func (t *TermDeposit) SizeSSZ() (size int) {
	size = 68
	return
}

// HashTreeRoot ssz hashes the TermDeposit object
func (t *TermDeposit) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(t)
}

// HashTreeRootWith ssz hashes the TermDeposit object with a hasher
func (t *TermDeposit) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'DepositId'
	hh.PutUint64(t.DepositId)
	...
	// Field (3) 'StartEpoch'
	hh.PutUint64(uint64(t.StartEpoch))

	// Field (4) 'TermDuration'
	hh.PutUint64(t.TermDuration)

	// Field (5) 'MaturityEpoch'
	hh.PutUint64(uint64(t.MaturityEpoch))

	// Field (6) 'GracePeriod'
	hh.PutUint64(t.GracePeriod)

	// Field (7) 'Status'
	hh.PutUint64(t.Status)

	// Field (8) 'RenewalCount'
	hh.PutUint32(t.RenewalCount)

	hh.Merkleize(indx)
	return
}

// MarshalSSZ ssz marshals the PendingTermDeposit object
func (p *PendingTermDeposit) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(p)
}

// MarshalSSZTo ssz marshals the PendingTermDeposit object to a target array
func (p *PendingTermDeposit) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	...
	// Field (5) 'TermDuration'
	dst = ssz.MarshalUint64(dst, p.TermDuration)

	// Field (6) 'GracePeriod'
	dst = ssz.MarshalUint64(dst, p.GracePeriod)

	return
}

// UnmarshalSSZ ssz unmarshals the PendingTermDeposit object
func (p *PendingTermDeposit) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 208 {
		return ssz.ErrSize
	...
	// Field (5) 'TermDuration'
	p.TermDuration = ssz.UnmarshallUint64(buf[192:200])

	// Field (6) 'GracePeriod'
	p.GracePeriod = ssz.UnmarshallUint64(buf[200:208])

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the PendingTermDeposit object
func (p *PendingTermDeposit) SizeSSZ() (size int) {
	size = 208
	return
}

// HashTreeRoot ssz hashes the PendingTermDeposit object
func (p *PendingTermDeposit) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(p)
}

// HashTreeRootWith ssz hashes the PendingTermDeposit object with a hasher
func (p *PendingTermDeposit) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (5) 'TermDuration'
	hh.PutUint64(p.TermDuration)

	// Field (6) 'GracePeriod'
	hh.PutUint64(p.GracePeriod)

	hh.Merkleize(indx)
	return
}

// MarshalSSZ ssz marshals the TermWithdrawalRequest object
func (t *TermWithdrawalRequest) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(t)
}

// MarshalSSZTo ssz marshals the TermWithdrawalRequest object to a target array
func (t *TermWithdrawalRequest) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	...
	// Field (2) 'PenaltyBps'
	dst = ssz.MarshalUint32(dst, t.PenaltyBps)
...
// UnmarshalSSZ ssz unmarshals the TermWithdrawalRequest object
func (t *TermWithdrawalRequest) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 28 {
		return ssz.ErrSize
	...
	// Field (2) 'PenaltyBps'
	t.PenaltyBps = ssz.UnmarshallUint32(buf[16:20])

	// Field (3) 'Slot'
	t.Slot = github_com_OffchainLabs_prysm_v6_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[20:28]))

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the TermWithdrawalRequest object
func (t *TermWithdrawalRequest) SizeSSZ() (size int) {
	size = 28
	return
}

// HashTreeRoot ssz hashes the TermWithdrawalRequest object
func (t *TermWithdrawalRequest) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(t)
}

// HashTreeRootWith ssz hashes the TermWithdrawalRequest object with a hasher
func (t *TermWithdrawalRequest) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
